...
app.post("/image-upload", upload.single("image"), async (req, res) => {
    try {
        ...
        const imageUrl = `https://traveldiary-back.onrender.com/uploads/${req.file.filename}`;
...
app.put("/edit-Story/:id", authenticateToken, async (req, res) => {
    ...
    try {
        ...
        const placeholderImgUrl = `https://traveldiary-back.onrender.com/assets/placeholder.jpeg`;
